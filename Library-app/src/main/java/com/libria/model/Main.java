...
public class Main {
    ...
    public static void main(String[] args) throws LoginException, BookAlreadyExistException, BookNotFoundException {
        ...
        User u1 = new Admin("U001", "Zakaria", "zakaria@libria.com", "1234");
        User u2 = new Member("U002", "Amir", "amir@libria.com", "abcd");
        ...
        library.addBook(u1,b1);
        library.addBook(u1,b2);
        library.addBook(u1,b3);
        library.addBook(u1,b4);
        ...
        library.removeBook(u1,b4.getIsbn());
